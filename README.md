...
- KeyStrike : A typing-based shooting game where players type enemy words to survive.
...
- Land a game development internship

### Featured Projects

## Snake Game

Classic Snake Game recreated using Python and Pygame.
Repository link :- https://github.com/RaghuveerSingh05/snake-game-py

## Breakout Clone

Arcade brick-breaker game with collision mechanics and score systems.
Repository link :- https://github.com/RaghuveerSingh05/Breakout-Pygame
